...
public class VendorCvGBMboostWithBoosterTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorCvGBMboostWithBoosterTest.class);
    ...
    public void loadNodesTest() throws JAXBException, SAXException {
        ...
        StreamSource streamSource =
            new StreamSource(VendorCvGBMboostWithBoosterTest.class.getResourceAsStream(XSD_LOCATION));
        Schema schema = schemaFactory.newSchema(streamSource);
        unmarshaller.setSchema(schema);

        Reporter.log("Load the CV file.", true);
        InputStream is = VendorCvGBMboostWithBoosterTest.class.getResourceAsStream("/bidib/BiDiBCV-13-103.xml");
