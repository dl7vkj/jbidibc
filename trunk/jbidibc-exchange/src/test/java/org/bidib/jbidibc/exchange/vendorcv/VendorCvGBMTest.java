...
public class VendorCvGBMTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorCvGBMTest.class);
    ...
    public void loadNodesTest() throws JAXBException, SAXException {
        ...
        StreamSource streamSource = new StreamSource(VendorCvGBMTest.class.getResourceAsStream(XSD_LOCATION));
        Schema schema = schemaFactory.newSchema(streamSource);
        unmarshaller.setSchema(schema);

        Reporter.log("Load the CV file.", true);
        InputStream is = VendorCvGBMTest.class.getResourceAsStream("/bidib/BiDiBCV-13-101.xml");
