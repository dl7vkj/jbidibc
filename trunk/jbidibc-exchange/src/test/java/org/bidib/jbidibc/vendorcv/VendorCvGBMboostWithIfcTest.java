...
public class VendorCvGBMboostWithIfcTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorCvGBMboostWithIfcTest.class);
    ...
    public void loadNodesTest() throws JAXBException, SAXException {
        ...
        StreamSource streamSource =
            new StreamSource(VendorCvGBMboostWithIfcTest.class.getResourceAsStream(XSD_LOCATION));
        Schema schema = schemaFactory.newSchema(streamSource);
        unmarshaller.setSchema(schema);

        Reporter.log("Load the CV file.", true);
        InputStream is = VendorCvGBMboostWithIfcTest.class.getResourceAsStream("/bidib/BiDiBCV-13-102.xml");
