...
public class VendorCvGBMboostWithBoosterAndIfcTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorCvGBMboostWithBoosterAndIfcTest.class);
    ...
    public void loadNodesTest() throws JAXBException, SAXException {
        ...
        StreamSource streamSource =
            new StreamSource(VendorCvGBMboostWithBoosterAndIfcTest.class.getResourceAsStream(XSD_LOCATION));
        Schema schema = schemaFactory.newSchema(streamSource);
        unmarshaller.setSchema(schema);

        Reporter.log("Load the CV file.", true);
        InputStream is = VendorCvGBMboostWithBoosterAndIfcTest.class.getResourceAsStream("/bidib/BiDiBCV-13-104.xml");
