...
public class VendorCvOneOcTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorCvOneOcTest.class);
    ...
    public void loadNodesTest() throws JAXBException, SAXException {
        ...
        StreamSource streamSource = new StreamSource(VendorCvOneOcTest.class.getResourceAsStream(XSD_LOCATION));
        Schema schema = schemaFactory.newSchema(streamSource);
        unmarshaller.setSchema(schema);

        Reporter.log("Load the CV file.", true);
        InputStream is = VendorCvOneOcTest.class.getResourceAsStream("/bidib/BiDiBCV-13-204.xml");
