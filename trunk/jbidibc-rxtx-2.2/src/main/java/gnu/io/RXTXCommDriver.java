    ...
    private boolean registerSpecifiedPorts(int PortType) {
        ...
        if (file_loc != null) {
            ...
            try {
                ...
                if (debug) {
                    System.out.println("RXTXCommDriver.registerSpecifiedPorts(): Error encountered while reading "
                        + file_loc + ": " + e);
                }
            }
            finally {
        ...
        if (props == null) {
            ...
            try {
                ...
                if (debug) {
                    System.out
                        .println("RXTXCommDriver.registerSpecifiedPorts(): Error encountered while getting gnu.io.rxtx.properties from the classpath: "
                            + e);
                }
            }
        }
        if (debug) {
            System.out.println("RXTXCommDriver.registerSpecifiedPorts(): checking for system-known ports of type "
                + PortType);
        }
        if (debug) {
            System.out.println("RXTXCommDriver.registerSpecifiedPorts(): checking registry for ports of type "
                + PortType);
        }
        ...
        if (props == null) {
            if (debug) {
                System.out
                    .println("RXTXCommDriver.registerSpecifiedPorts(): RxTx ports not specified in properties file, checking system properties... ");
            }
            ...
            if (serialProp != null || parallelProp != null) {
                ...
                if (serialProp != null) {
                    if (debug) {
                        System.out
                            .println("RXTXCommDriver.registerSpecifiedPorts(): Found gnu.io.rxtx.SerialPorts property with value of ["
                                + serialProp + "]");
                    }
                ...
                if (parallelProp != null) {
                    if (debug) {
                        System.out
                            .println("RXTXCommDriver.registerSpecifiedPorts(): Found gnu.io.rxtx.ParallelPorts property with value of ["
                                + parallelProp + "]");
                    }
        ...
        if (props != null) {
            switch (PortType) {
                ...
                default:
                    if (debug) {
                        System.out.println("RXTXCommDriver.registerSpecifiedPorts(): unknown port type " + PortType
            ...
            if (debug) {
                System.out
                    .println("RXTXCommDriver.registerSpecifiedPorts(): The file: gnu.io.rxtx.properties doesn't exist and the properties weren't specified as a system property.");
            }
        }
        if (val != null) {
        ...
        switch (PortType) {
            case CommPortIdentifier.PORT_SERIAL:
                ...
                if (osName.equals("Linux")) {
                    String[] Temp = { "ttyAMA", // Raspberry Pi serial ports
