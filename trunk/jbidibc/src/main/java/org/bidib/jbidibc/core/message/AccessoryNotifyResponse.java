...
public class AccessoryNotifyResponse extends BidibMessage {
    public static final Integer TYPE = BidibLibrary.MSG_ACCESSORY_NOTIFY;
    ...
    public AccessoryNotifyResponse(byte[] addr, int num, byte accessoryNum, byte aspect, byte[] value)
        throws ProtocolException {
        this(addr, num, BidibLibrary.MSG_ACCESSORY_NOTIFY, ByteUtils.concat(new byte[] { accessoryNum, aspect }, value));
    }
