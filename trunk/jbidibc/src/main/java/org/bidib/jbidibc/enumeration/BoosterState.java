...
public enum BoosterState implements BidibEnum {
    //@formatter:off
    OFF(BidibLibrary.BIDIB_BST_STATE_OFF), SHORT(BidibLibrary.BIDIB_BST_STATE_SHORT), OFF_HOT(
        BidibLibrary.BIDIB_BST_STATE_OFF_HOT), NO_POWER(BidibLibrary.BIDIB_BST_STATE_NOPOWER), GO_REQ(
        BidibLibrary.BIDIB_BST_STATE_OFF_GO_REQ), ON(BidibLibrary.BIDIB_BST_STATE_ON), ON_LIMIT(
        BidibLibrary.BIDIB_BST_STATE_ON_LIMIT), ON_HOT(BidibLibrary.BIDIB_BST_STATE_ON_HOT), ON_STOP_REQ(
        BidibLibrary.BIDIB_BST_STATE_ON_STOP_REQ);
