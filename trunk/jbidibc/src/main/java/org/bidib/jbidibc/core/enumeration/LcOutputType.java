...
public enum LcOutputType implements BidibEnum, PortStatusAware {
    ...
    SWITCHPORT(BidibLibrary.BIDIB_OUTTYPE_SPORT, true), LIGHTPORT(BidibLibrary.BIDIB_OUTTYPE_LPORT, true), SERVOPORT(
        ...
        BidibLibrary.BIDIB_MSYS_FLAG_SET), FLAG_QUERY(BidibLibrary.BIDIB_MSYS_FLAG_QUERY1), FLAG_QUERY1(
        BidibLibrary.BIDIB_MSYS_FLAG_QUERY1), FLAG_QUERY0(BidibLibrary.BIDIB_MSYS_FLAG_QUERY0), END_CRITICAL(
