...
public enum FeatureEnum implements BidibEnum {
    ...
    FEATURE_BM_SIZE(BidibLibrary.FEATURE_BM_SIZE, 0, 128), FEATURE_BM_ON(BidibLibrary.FEATURE_BM_ON, 0, 1), FEATURE_BM_SECACK_AVAILABLE(
        BidibLibrary.FEATURE_BM_SECACK_AVAILABLE, 0, 1), FEATURE_BM_SECACK_ON(BidibLibrary.FEATURE_BM_SECACK_ON, 0, null), FEATURE_BM_CURMEAS_AVAILABLE(
        BidibLibrary.FEATURE_BM_CURMEAS_AVAILABLE, 0, 1), FEATURE_BM_CURMEAS_INTERVAL(
        BidibLibrary.FEATURE_BM_CURMEAS_INTERVAL, 0, null), FEATURE_BM_DC_MEAS_AVAILABLE(
        BidibLibrary.FEATURE_BM_DC_MEAS_AVAILABLE, 0, 1), FEATURE_BM_DC_MEAS_ON(BidibLibrary.FEATURE_BM_DC_MEAS_ON, 0, 1), FEATURE_BM_ADDR_DETECT_AVAILABLE(
        BidibLibrary.FEATURE_BM_ADDR_DETECT_AVAILABLE, 0, 1), FEATURE_BM_ADDR_DETECT_ON(
        BidibLibrary.FEATURE_BM_ADDR_DETECT_ON, 0, 1), FEATURE_BM_ADDR_AND_DIR(BidibLibrary.FEATURE_BM_ADDR_AND_DIR, 0, 1), FEATURE_BM_ISTSPEED_AVAILABLE(
        BidibLibrary.FEATURE_BM_ISTSPEED_AVAILABLE, 0, 1), FEATURE_BM_ISTSPEED_INTERVAL(
        BidibLibrary.FEATURE_BM_ISTSPEED_INTERVAL, 0, null), FEATURE_BM_CV_AVAILABLE(BidibLibrary.FEATURE_BM_CV_AVAILABLE, 0, 1), FEATURE_BM_CV_ON(
        BidibLibrary.FEATURE_BM_CV_ON, 0, 1),
    // BOOSTER
    ...
    // LC
    FEATURE_CTRL_INPUT_COUNT(BidibLibrary.FEATURE_CTRL_INPUT_COUNT, 0, 127), FEATURE_CTRL_INPUT_NOTIFY(BidibLibrary.FEATURE_CTRL_INPUT_NOTIFY, 0, 1), 
    FEATURE_CTRL_SPORT_COUNT(BidibLibrary.FEATURE_CTRL_SPORT_COUNT, 0, 127), FEATURE_CTRL_LPORT_COUNT(BidibLibrary.FEATURE_CTRL_LPORT_COUNT, 0, 127), 
    FEATURE_CTRL_SERVO_COUNT(BidibLibrary.FEATURE_CTRL_SERVO_COUNT, 0, 127), FEATURE_CTRL_SOUND_COUNT(BidibLibrary.FEATURE_CTRL_SOUND_COUNT, 0, 127),
    FEATURE_CTRL_MOTOR_COUNT(BidibLibrary.FEATURE_CTRL_MOTOR_COUNT, 0, 127), FEATURE_CTRL_ANALOG_COUNT(BidibLibrary.FEATURE_CTRL_ANALOG_COUNT, 0, 127),
    FEATURE_CTRL_MAC_SIZE(BidibLibrary.FEATURE_CTRL_MAC_SIZE), FEATURE_CTRL_MAC_COUNT(
        ...
        BidibLibrary.FEATURE_CTRL_MAC_START_DCC, 0, 1), FEATURE_CTRL_MAC_START_MAN(BidibLibrary.FEATURE_CTRL_MAC_START_MAN, 0, 1), FEATURE_CTRL_MAC_SAVE(
        BidibLibrary.FEATURE_CTRL_MAC_SAVE);
    //@formatter:on
