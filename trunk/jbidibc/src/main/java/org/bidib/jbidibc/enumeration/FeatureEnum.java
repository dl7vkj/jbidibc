...
public enum FeatureEnum implements BidibEnum {
    ...
    FEATURE_BM_SIZE(BidibLibrary.FEATURE_BM_SIZE, 0, 128), FEATURE_BM_ON(BidibLibrary.FEATURE_BM_ON, 0, 1), FEATURE_BM_SECACK_AVAILABLE(
        BidibLibrary.FEATURE_BM_SECACK_AVAILABLE, 0, 1), FEATURE_BM_SECACK_ON(BidibLibrary.FEATURE_BM_SECACK_ON, 0, 255), FEATURE_BM_CURMEAS_AVAILABLE(
    ...
    FEATURE_BST_VOLT_ADJUSTABLE(BidibLibrary.FEATURE_BST_VOLT_ADJUSTABLE, 0, 1), FEATURE_BST_VOLT(
        ...
        BidibLibrary.FEATURE_BST_INHIBIT_LOCAL_ONOFF, 0, 1), FEATURE_BM_DYN_STATE_INTERVAL(
        BidibLibrary.FEATURE_BM_DYN_STATE_INTERVAL, 0, 100),
    // 29 - 40 missing
    // ACCESSORY
    ...
    FEATURE_GEN_SPYMODE(BidibLibrary.FEATURE_GEN_SPYMODE, 0, 1), FEATURE_GEN_WATCHDOG(
        ...
        BidibLibrary.FEATURE_GEN_LOK_DB_STRING), FEATURE_GEN_POM_REPEAT(BidibLibrary.FEATURE_GEN_POM_REPEAT, 2, 8), FEATURE_GEN_DRIVE_BUS(
        ...
        BidibLibrary.FEATURE_GEN_NOTIFY_DRIVE_MANUAL, 0, 1), FEATURE_GEN_START_STATE(
        BidibLibrary.FEATURE_GEN_START_STATE, 0, 1),
    // FIRMWARE UPDATE
    ...
    FEATURE_CTRL_INPUT_COUNT(BidibLibrary.FEATURE_CTRL_INPUT_COUNT, 0, 127), FEATURE_CTRL_INPUT_NOTIFY(
        ...
        BidibLibrary.FEATURE_CTRL_STRETCH_DIMM, 1, 250), FEATURE_CTRL_BACKLIGHT_COUNT(
        BidibLibrary.FEATURE_CTRL_BACKLIGHT_COUNT), FEATURE_CTRL_MAC_LEVEL(BidibLibrary.FEATURE_CTRL_MAC_LEVEL, 0, 2), FEATURE_CTRL_MAC_SAVE(
        BidibLibrary.FEATURE_CTRL_MAC_SAVE), FEATURE_CTRL_MAC_SIZE(BidibLibrary.FEATURE_CTRL_MAC_SIZE), FEATURE_CTRL_MAC_COUNT(
