...
call mvn gpg:sign-and-deploy-file -Dfile=RXTXcomm-2.2.jar -DpomFile=rxtxcomm-2.2.pom -Dsources=rxtxcomm-2.2-sources.jar -Djavadoc=rxtxcomm-2.2-javadoc.jar -Durl=https://oss.sonatype.org/service/local/staging/deploy/maven2/ -DrepositoryId=sonatype-nexus-staging 